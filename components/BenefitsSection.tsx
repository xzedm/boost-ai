...
export default function BenefitsSection() {
  return (
    <div className="py-16 sm:py-24 lg:pt40">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* Section header */}
        <div className="mx-auto max-w-2xl text-center lg:text-center">
          <p className="text-2xl sm:text-4xl lg:text-5xl font-semibold tracking-tight text-white text-balance leading-tight">
            Powerful AI tools to accelerate your growth
          </p>
          <p className="mt-4 sm:mt-6 text-base sm:text-lg text-gray-300 leading-relaxed">
            Boost AI helps you automate workflows, gain real-time insights, and
            scale faster with intelligent solutions built for modern teams.
          </p>
        </div>

        {/* Features grid */}
        <div className="mx-auto mt-12 sm:mt-16 lg:mt-24 max-w-2xl lg:max-w-4xl">
          <dl className="grid grid-cols-1 gap-x-8 gap-y-8 sm:gap-y-10 lg:grid-cols-2 lg:gap-y-16">
