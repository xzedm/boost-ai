...
import { FadeUp, WordReveal } from "./Animations";
    ...
    <div className="flex gap-0.5" aria-label={`${count} out of 5 stars`}>
      {Array.from({ length: 5 }).map((_, i) => (
        <Star
          ...
          size={14}
          className={
            i < count ? "fill-indigo-400 text-indigo-400" : "text-zinc-600"
          }
        />
      ))}
    </div>
...
export default function FeedbackSection() {
  ...
  return (
    <section
      ...
      className="py-16 sm:py-18 lg:py-10"
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 sm:mb-14">
          <h2
            ...
            className="text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight text-white text-balance leading-tight"
          >
            <WordReveal
          ...
          <FadeUp delay={0.25} duration={0.6}>
        ...
        <div className="overflow-hidden px-4 sm:px-6 lg:px-8" ref={emblaRef}>
          <div className="flex" role="list">
            {testimonials.map((t) => (
              ...
              >
                <figure className="h-full flex flex-col justify-between gap-5 bg-zinc-900/70 border border-zinc-800 rounded-2xl p-6 sm:p-7 backdrop-blur-sm hover:border-indigo-500/40 transition-colors duration-300">
